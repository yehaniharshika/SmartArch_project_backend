...
# Room label pattern
# LABEL_PATTERN — expanded to cover all room types seen across test plans
# (TERRACE, BAL: for balcony abbreviation, COURTYARD, SHOP added)
LABEL_PATTERN = re.compile(
    r'(BED\s*ROOM|MASTER\s*BED|BATH\s*ROOM|BATHROOM|KITCHEN|LIVING|'
    r'DINING|GARAGE|CAR\s*PORCH|CORRIDOR|BALCONY|BAL\s*:|STAIRCASE|TOILET|'
    r'STORE\s*ROOM|STORE|HALL|PANTRY|UTILITY|VERANDA|VERANDAH|LOBBY|VISITOR|'
    r'FAMILY|STUDY|LAUNDRY|OFFICE|PRAYER|DRAWING|TERRACE|COURTYARD|SHOP)',
    re.IGNORECASE
)
